...
examples = [ ("add", TypeInt)
           ...
           , ("case_fn", TypeInt)
           , ("constructor", TypeGeneral (AnnVar 1) [TypeInt, TypeBool, TypeInt])
           , ("dtype", TypeGeneral (AnnVar 1) [TypeInt, TypeBool, TypeInt, TypeBool])
           ...
           , ("lcase_fun", TypeGeneral (AnnVar 1) [TypeInt])
           , ("lcase", TypeInt)
           , ("let_bool", TypeBool)
